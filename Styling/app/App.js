...
const styles = StyleSheet.create({
    container: {
        // These lines below drew on ideas from Ch. 5 in React Native in Action
        flex: 1,
        flexDirection: 'column',
        flexWrap: 'wrap',
        alignItems: 'flex-start',
        // These lines above drew on ideas from Ch. 5 in React Native in Action
    ...
    */
    ...
    /*
        The cardThumbnail style reduces the component’s size by 40%.
    */
        cardThumbnail: {
          transform: [{scale: 0.6}]
      },
